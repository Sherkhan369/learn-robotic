...
const config: Config = {
  ...
  tagline: 'Comprehensive Guide to Building Intelligent Robotic Systems',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/Sherkhan369/learn-robotic/tree/main/frontend/',
        },
        blog: {
